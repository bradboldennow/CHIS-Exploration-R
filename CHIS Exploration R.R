...
# Age colored histogram by BMI, default binwidth
...
adult$RACEHPR2 <- factor(adult$RACEHPR2, labels = c("Latino", "Pacific Islander", "Native American", "Asian", "African American", "White", "Other"))
